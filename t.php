...
$sql = "select * from vehicledetails where VehicleType='TAXI'  AND StartLocation like'%$from%' AND EndLocation like'%$to%'   AND Date like'%$date%'   ";
...
<script>
    function redirectToPage() {
      window.location.href = "seatt.php";  // Replace with your desired URL
    }
  </script>